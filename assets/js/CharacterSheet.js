class CharacterSheet {
  ...
  showCharacterSheet() {
    this.tabs = $('<div class="tab-content" id="pills-tabContent"/>').appendTo(
      this.element
    );

    //DOM CARACTERISTIQUE
    let caracDiv = $(
      ' <div class="tab-pane fade show active" id="pills-carac" role="tabpanel" aria-labelledby="pills-carac-tab"/>'
    ).appendTo(this.tabs);
    let caracTable = $(
      ' <table class="table caption-top caracTable" style="max-width:800px;"/>'
    ).appendTo(caracDiv);
    ...
    let nameOfCharacLbl = $(
      '<td><label for="name" class="label characName">Nom du perso</label></br><input type="text" class="input characName"/></td>'
    ).appendTo(characFirstRow);
    let race = $(
      '<td><label for="race"> Race </label></br><select name="race" id="race"> <option value = " " ></option><option value = "Humain" > Humain </option > <option value = "Elfe" > Elfe </option> <option value = "Nain" > Nain </option > <option value = "Gnome" > Gnome </option> <option value = "Halfelin" > Halfelin </option > <option value = "Demi-Elfe" > Demi-Elfe </option> <option value = "Demi-Orc" > Demi-Orc </option > </select></td>'
    ).appendTo(characFirstRow);
    let bonusRace = $(
      '<td id="bonusRaceTd"><label for="bonusRace">Appliquer bonus de race à : </label></br><select name="capacités" id="capacite"><option value = " " ></option><option value = "force" > Force </option > <option value = "dext" > Dextérité </option> <option value = "constit" > Constitution </option > <option value = "intel" > Intelligence </option> <option value = "sage" > Sagesse </option > <option value = "charism" > Charisme </option></select></td>'
    ).appendTo(characFirstRow);
    bonusRace.hide();
    race.change(function () {
      if (
        $("#race option:selected").val() == "Humain" ||
        $("#race option:selected").val() == "Demi-Elfe" ||
        $("#race option:selected").val() == "Demi-Orc"
      ) {
        $("#bonusRaceTd").fadeIn();
    ...
    let class1OfCharac = $(
      '<td><label for="classe1">Classe </label><br/><select name="classe1" id="classe1"><option value = " " > </option> <option value = "Barbare" > Barbare </option> <option value = "Barde" > Barde </option> <option value = "Druide" > Druide </option> <option value = "Ensorceleur" > Ensorceleur </option> <option value = "Guerrier" > Guerrier </option> <option value = "Magicien" > Magicien </option> <option value = "Moine" > Moine </option> <option value = "Paladin" > Paladin </option> <option value = "Prêtre"> Prêtre </option> <option value = "Rodeur"> Rodeur </option> <option value ="Roublard"> Roublard </option></select></td> '
    ).appendTo(characSecondRow);
    let class2OfCharac = $(
      '<td><label for="classe2">Classe 2</label><br/><select name="classe_2" id="classe2"><option value = " " >  </option><option value = "Barbare" > Barbare </option> <option value = "Barde" > Barde </option> <option value = "Druide" > Druide </option> <option value = "Ensorceleur" > Ensorceleur </option> <option value = "Guerrier" > Guerrier </option> <option value = "Magicien" > Magicien </option> <option value = "Moine" > Moine </option><option value = "Paladin" > Paladin </option><option value = "Prêtre" > Prêtre </option><option value = "Rodeur" > Rodeur </option><option value = "Roublard" > Roublard </option></select></td> '
    ).appendTo(characSecondRow);
    let class3OfCharac = $(
    ...
    let alignement = $(
      '<td><label for="alignement"> Alignement </label></br><select name="alignement" id="alignement"><option value = " " >  </option><option value = "Loyal Bon" > Loyal Bon </option> <option value ="Loyal Neutre" > Loyal Neutre </option> <option value = "Loyal Mauvais" > Loyal Mauvais </option> <option value = "Neutre Bon" > Neutre Bon </option> <option value = "Neutre" > Neutre </option> <option value = "Neutre Mauvais" > Neutre Mauvais </option> <option value = "Chaotique Bon" > Chaotique Bon </option><option value = "Chaotique Neutre" > Chaotique Neutre </option><option value = "Chaotique Mauvais" > Chaotique Mauvais </option></select ></td> '
    ).appendTo(characThirdRow);
    let characLevelLbl = $(
      "<td><label for='niveau' class='characLvlLbl'>Niveau du Personnage </label></br><input type='number' class='characLvlInpt' value='1' /></td>"
    ).appendTo(characThirdRow);
    //LOGIQUE CARACTERISTIQUE
    class1OfCharac.change(function () {
      $("#alignement option").prop("disabled", false);
      if ($("#classe1 option:selected").val() == "Barbare") {
        $("#alignement option:contains('Loyal')").prop("disabled", true);
      } else if ($("#classe1 option:selected").val() == "Druide") {
        $("#alignement option")
          .not(":contains('Neutre')")
          .prop("disabled", true);
      } else if ($("#classe1 option:selected").val() == "Moine") {
        $("#alignement option")
          .not(":contains('Loyal')")
          .prop("disabled", true);
      } else if ($("#classe1 option:selected").val() == "Paladin") {
        $("#alignement option")
          .not(":contains('Loyal Bon')")
          .prop("disabled", true);
      }
    });
    class2OfCharac.change(function () {
      $("#alignement option").prop("disabled", false);
      if ($("#classe2 option:selected").val() == "Barbare") {
        $("#alignement option:contains('Loyal')").prop("disabled", true);
      } else if ($("#classe2 option:selected").val() == "Druide") {
        $("#alignement option")
          .not(":contains('Neutre')")
          .prop("disabled", true);
      } else if ($("#classe2 option:selected").val() == "Moine") {
        $("#alignement option")
          .not(":contains('Loyal')")
          .prop("disabled", true);
      } else if ($("#classe2 option:selected").val() == "Paladin") {
        $("#alignement option")
          .not(":contains('Loyal Bon')")
          .prop("disabled", true);
      }
    });
    class3OfCharac.change(function () {
      $("#alignement option").prop("disabled", false);
      if ($("#classe3 option:selected").val() == "Barbare") {
        $("#alignement option:contains('Loyal')").prop("disabled", true);
      } else if ($("#classe3 option:selected").val() == "Druide") {
        $("#alignement option")
          .not(":contains('Neutre')")
          .prop("disabled", true);
      } else if ($("#classe3 option:selected").val() == "Moine") {
        $("#alignement option")
          .not(":contains('Loyal')")
          .prop("disabled", true);
      } else if ($("#classe3 option:selected").val() == "Paladin") {
        $("#alignement option")
          .not(":contains('Loyal Bon')")
          .prop("disabled", true);
      }
    ...
    //DOM HABILITE
    let abilityDiv = $(
      '<div class="tab-pane fade" id="pills-ability" role="tabpanel" aria-labelledby="pills-ability-tab"/>'
    ).appendTo(this.tabs);
    let abilityTable = $('<table class="table charac-tb abiliyTab"/>').appendTo(
      abilityDiv
    );
    let abilityTitle = $("<h1>HABILITÉS</h1>").appendTo(abilityTable);
    let messageRoll = $(
      '<tr><td id="messageRoll" style="text-align:center;" colspan="3">Choisir une méthode pour roll les abilités de votre personnage.</td></tr>'
    ).appendTo(abilityTable);
    let methodRoll = $(
      '<tr id="methodRoll"><td><input type="radio" class="btn-check" id="methodStandard" name="method" autocomplete="off"><label class="btn btn-outline-success metStandard" for="methodStandard">Méthode standard</label></td><td><input type="radio" class="btn-check" id="methodClassic" name="method" autocomplete="off"><label class="btn btn-outline-secondary metClassic" for="methodClassic">Méthode classique</label></td><td><input type="radio" class="btn-check" id="methodheroic" name="method" autocomplete="off"><label class="btn btn-outline-danger metHeroic" for="methodheroic">Méthode héroïque</label></td></tr>'
    ).appendTo(abilityTable);
    let avmTr = $("<tr/>").appendTo(abilityTable);
    let avmTh = $(
      "<th></th><th> Valeur </th><th> Val Temporaire </th><th> Modificateur </th><th> Roll </th>"
    ).appendTo(avmTr);
    let forceTr = $(
      '<tr><td> Force </td><td><input type="number" value="' +
        this.options.force +
        '" id="forceScore" min="8" max="20" data-bonusRace="0"></td><td><input type="number" value="' +
        this.options.force +
        '" id="forceScoreTemp"></td><td><input type="number " value="' +
        this.options.modForce +
        '" id="forceMod"></td><td class="rollTd"><input class="btnRoll" type="button" value="Roll" id="forceScoreRoll"></td></tr>'
    ).appendTo(abilityTable);
    let dextTr = $(
      '<tr><td> Dextérité </td><td><input type="number" value="' +
        this.options.dexterite +
        '" id="dextScore" min="8" max="20" data-bonusRace="0"></td><td><input type="number" value="' +
        this.options.dexterite +
        '" id="dextScoreTemp"></td><td><input type="number" value="' +
        this.options.modDexterite +
        '" id="dextMod"></td><td class="rollTd"><input type="button" class="btnRoll" value="Roll" id="dextScoreRoll"></td></tr>'
    ).appendTo(abilityTable);
    let constitTr = $(
      '<tr><td> Constitution </td><td><input type="number" value="' +
        this.options.constitution +
        '" id="constitScore" min="8" max="20" data-bonusRace="0"></td><td><input type="number" value="' +
        this.options.constitution +
        '" id="constitScoreTemp"></td><td><input type="number" value="' +
        this.options.modConstitution +
        '" id="constitMod"></td><td class="rollTd"><input type="button" class="btnRoll" value="Roll" id="constitScoreRoll"></td></tr>'
    ).appendTo(abilityTable);
    let intelTr = $(
      '<tr><td> Intelligence </td><td><input type="number" value="' +
        this.options.intelligence +
        '" id="intelScore" min="8" max="20" data-bonusRace="0"></td><td><input type="number" value="' +
        this.options.intelligence +
        '" id="intelScoreTemp"></td><td><input type="number" value="' +
        this.options.modIntelligence +
        '" id="intelMod"></td><td class="rollTd"><input type="button" class="btnRoll" value="Roll" id="intelScoreRoll"></td></tr>'
    ).appendTo(abilityTable);
    let sageTr = $(
      '<tr><td> Sagesse </td><td><input type="number" value="' +
        this.options.sagesse +
        '" id="sageScore" min="8" max="20" data-bonusRace="0"</td><td><input type="number" value="' +
        this.options.sagesse +
        '" id="sageScoreTemp"></td><td><input type="number" value="' +
        this.options.modSagesse +
        '" id="sageMod"></td><td class="rollTd"><input type="button" class="btnRoll" value="Roll" id="sageScoreRoll"></td></tr>'
    ).appendTo(abilityTable);
    let charismTr = $(
      '<tr><td> Charisme </td><td><input type="number" value="' +
        this.options.charisme +
        '" id="charismScore" min="8" max="20" data-bonusRace="0"></td><td><input type="number" value="' +
        this.options.charisme +
        '" id="charismScoreTemp"></td><td><input type="number" value="' +
        this.options.modCharisme +
        '" id="charismMod"></td><td class="rollTd"><input type="button" class="btnRoll" value="Roll" id="charismScoreRoll"></td></tr>'
    ).appendTo(abilityTable);
    //LOGIQUE ABILITÉ
    $(".rollTd").hide();
    methodRoll.change(function () {
      if ($("#methodStandard:checked").val() == "on") {
        $("#messageRoll").text(
          "On roll 4D6 et on supprime le plus petit résultat."
        );
        $(".rollTd").show();
        $(".btnRoll").click(function () {
          ...
          let final =
            roll1 + roll2 + roll3 + roll4 - smallestRoll + bonusRaceAbility;
          ...
          let abilityModInt = Math.trunc(
            Math.floor($(abilityScoreId).val() - 10) / 2
          );
...
*/
    ...
    let skillTable = $(
      ' <table class="skillsTab" style="max-width:800px;"/>'
    ).appendTo(skillsDiv);
    let skillTitle = $("<h1>COMPÉTENCES</h1>").appendTo(skillTable);
    let proficiencyBonusLbl = $(
      "<label for='Bonus de Competence' class='bonusLbl'>Bonus de Compétences : </label>"
    ).appendTo(skillTable);
    let proficiencyBonusInpt = $(
      "<input type='number' class='bonusInpt' value='2'/>"
    ).appendTo(proficiencyBonusLbl);
    let bonusPro = parseInt($(".bonusInpt").attr("value"));

    let acrobatSkill = $(
      '<tr><td><input type="checkbox" class="skillCheck" id="acro-Prof"></td><td> Acrobaties: </td><td><input type="number" class="skillNum" id="acroScore" ></td></tr> '
    ).appendTo(skillTable);
    let aracaneSkill = $(
      '<tr><td><input type="checkbox" class="skillCheck" id="arca-Prof"></td><td> Arcane: </td><td><input type="number" class="skillNum" id="arcaScore" ></td></tr> '
    ).appendTo(skillTable);
    let artisanatSkill = $(
      '<tr><td><input type="checkbox" class="skillCheck" id="arti-Prof"></td><td> Artisanat: </td><td><input type="number" class="skillNum" id="artiScore" ></td></tr> '
    ).appendTo(skillTable);
    let athletismSkill = $(
      '<tr><td><input type="checkbox" class="skillCheck" id="athle-Prof"></td><td> Athlétisme: </td><td><input type="number" class="skillNum" id="athleScore" ></td></tr> '
    ).appendTo(skillTable);
    let diploSkill = $(
      '<tr><td><input type="checkbox" class="skillCheck" id="diplo-Prof"></td><td> Diplomatie: </td><td><input type="number" class="skillNum" id="diploScore" ></td></tr> '
    ).appendTo(skillTable);
    let discretSkill = $(
      '<tr><td><input type="checkbox" class="skillCheck" id="discret-Prof"></td><td> Discrétion: </td><td><input type="number" class="skillNum" id="discretScore" ></td></tr> '
    ).appendTo(skillTable);
    let intimidSkill = $(
      '<tr><td><input type="checkbox" class="skillCheck" id="intim-Prof"></td><td> Intimidation: </td><td><input type="number" class="skillNum" id="intimScore" ></td></tr> '
    ).appendTo(skillTable);
    let medecineSkill = $(
      '<tr><td><input type="checkbox" class="skillCheck" id="med-Prof"></td><td> Médecine: </td><td><input type="number" class="skillNum" id="medScore" ></td></tr> '
    ).appendTo(skillTable);
    let natureSkill = $(
      '<tr><td><input type="checkbox" class="skillCheck" id="nat-Prof"></td><td> Nature: </td><td><input type="number" class="skillNum" id="natScore" ></td></tr> '
    ).appendTo(skillTable);
    let occultSkill = $(
      '<tr><td><input type="checkbox" class="skillCheck" id="occult-Prof"></td><td> Occulte: </td><td><input type="number" class="skillNum" id="occultScore" ></td></tr> '
    ).appendTo(skillTable);
    let volSkill = $(
      '<tr><td><input type="checkbox" class="skillCheck" id="vol-Prof"></td><td> Vol à la tire: </td><td><input type="number" class="skillNum" id="volScore" ></td></tr> '
    ).appendTo(skillTable);
    let religSkill = $(
      '<tr><td><input type="checkbox" class="skillCheck" id="relig-Prof"></td><td> Religion: </td><td><input type="number" class="skillNum" id="religScore" ></td></tr> '
    ).appendTo(skillTable);
    let representationSkill = $(
      '<tr><td><input type="checkbox" class="skillCheck" id="represent-Prof"></td><td> Représentation: </td><td><input type="number" class="skillNum" id="representScore" ></td></tr> '
    ).appendTo(skillTable);
    let savoirSkill = $(
      '<tr><td><input type="checkbox" class="skillCheck" id="savoir-Prof"></td><td> Savoir: </td><td><input type="number" class="skillNum" id="savoirScore" ></td></tr> '
    ).appendTo(skillTable);
    let societeSkill = $(
      '<tr><td><input type="checkbox" class="skillCheck" id="societe-Prof"></td><td> Société: </td><td><input type="number" class="skillNum" id="societeScore" ></td></tr> '
    ).appendTo(skillTable);
    let survieSkill = $(
      '<tr><td><input type="checkbox" class="skillCheck" id="survie-Prof"></td><td> Survie: </td><td><input type="number" class="skillNum" id="survieScore" ></td></tr> '
    ).appendTo(skillTable);
    let tromperieSkill = $(
      '<tr><td><input type="checkbox" class="skillCheck" id="trmperie-Prof"></td><td> Tromperie: </td><td><input type="number" class="skillNum" id="trmperieScore" ></td></tr> '
    ).appendTo(skillTable);
